...
```
  ...
  git clone https://github.com/Zuwairanajma/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/Zuwairanajma/hello-rails-react-app/issues).
